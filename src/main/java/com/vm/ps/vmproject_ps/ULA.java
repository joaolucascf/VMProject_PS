    ...
    private void execute(String opCode, String operand){
        ...
        switch (Integer.valueOf(opCode)){
            ...
            case 76:
                ...
                break;
            case 164:
                reg.registerSet.get(Byte.parseByte(regs[0], 2)).setValue((short) (reg.registerSet.get(regs[0]).getValue() << reg.registerSet.get(regs[4]).getValue()));                break;
            case 168:
                reg.registerSet.get(Byte.parseByte(regs[0], 2)).setValue((short) (reg.registerSet.get(regs[0]).getValue() >> reg.registerSet.get(regs[4]).getValue()));
                break;
            case 12:
